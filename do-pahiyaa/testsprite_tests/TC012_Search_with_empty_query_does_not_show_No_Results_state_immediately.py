...
async def run_test():
    ...
    try:
        ...
        await expect(frame.locator('xpath=//input[@placeholder="Search"]').first).to_be_visible(timeout=3000)
        await expect(frame.locator('xpath=//div[@aria-label="ListingCards list"]').first).to_be_visible(timeout=3000)
