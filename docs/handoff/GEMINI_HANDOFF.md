...
- `AGENTS.md` (persistent workspace contract)
- `docs/context/PROJECT_CONTEXT.md` (project-specific context and priorities)
- `GEMINI.md` (master technical constitution)
- `docs/governance/PERFORMANCE_GLOBAL_RULES.md` (mandatory performance engineering standards)
- `docs/governance/PERFORMANCE_CHECKLIST.md` (validation checklist)
- `docs/handoff/GEMINI_WORKFLOW_BOOTSTRAP.md` (copy-paste session bootstrap prompt)
